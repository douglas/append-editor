...
const PrintDialog_1 = require("./PrintDialog");
const EditNote_1 = require("./EditNote");
const ViewNote_1 = require("./ViewNote");
const AppendText_1 = require("./AppendText");
...
let keyMap = new Map();
class AppendEditor extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.getAppendText = () => {
            this.editorKit.internal.componentManager.streamContextItem((note) => {
                ...
                if (note.content.appendEditorFontEdit ||
        ...
        this.onSaveAppendTextAndCheckboxes = (text, newLine, newParagraph) => {
        ...
        this.onConfirmSettings = ({ fontEdit }, { fontView }) => {
            this.setState({
                fontEdit: fontEdit,
                fontView: fontView,
                showSettings: false,
    ...
    configureEditorKit() {
        let delegate = new EditorKitDelegate({
            setEditorRawText: (text) => {
                this.setState(Object.assign(Object.assign({}, initialState), { text }), () => {
                    this.onRefreshEdit();
                });
            },
        });
