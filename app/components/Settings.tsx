...
export default class Settings extends React.Component<MyProps, myState> {
  ...
  handleChange(event : React.ChangeEvent<HTMLInputElement>) {
    ...
    if (name === "fontEdit") {
      this.setState({
        fontEdit: event.target.value,
      });
    }
    else if (name === "fontView") {
      this.setState({
        fontView: event.target.value,
      })
    }
    /*this.setState({
  ...
  clearFontEdit = () => {
    ...
    const fontEdit = document.getElementById("fontEdit") as HTMLInputElement;
    fontEdit.value = "";
    fontEdit.focus();
  }
  ...
  clearFontView = () => {
    ...
    const fontView = document.getElementById("fontView") as HTMLInputElement;
    fontView.value = "";
    fontView.focus();
  }
