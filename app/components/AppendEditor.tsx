...
//export interface AppendEditorProps { }
...
export default class AppendEditor extends React.Component<{}, AppProps> {
  ...
  onSave = ({ text }: AppProps) => {
    this.editText(text);
  };

  onSaveAppendText = (text: string) => {
  ...
  onSaveAppendTextAndCheckboxes = (text: string, newLine: boolean, newParagraph: boolean) => {
  ...
  onEditMode = () => {
    ...
    if (this.state.appendMode && !this.state.editMode) {
      const appendTextArea = (document.getElementById('appendTextArea') as HTMLInputElement);
  ...
  onConfirmSettings = ({ fontEdit }: AppProps, { fontView }: AppProps) => {
    this.setState({
      fontEdit: fontEdit,
      fontView: fontView,
      showSettings: false,
          ...
          <div id="header">
            <div className="sk-button-group">
              <button
                ...
                className={
                  'sk-button info ' + (this.state.editMode ? 'on' : 'off')
                }
              >
              ...
              <button
                ...
                className={
                  'sk-button info ' + (this.state.appendMode ? 'on' : 'off')
                }
              >
